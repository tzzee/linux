...
static struct usb_device_id rtw_usb_id_tbl[] = {
	...
	{USB_DEVICE(0x04BB, 0x0952), .driver_info = RTL8812}, /* I-O Data - WN-AC867U */
	{USB_DEVICE(0x0789, 0x016E), .driver_info = RTL8812}, /* Logitec - AC866 */
	{USB_DEVICE(0x0409, 0x0408), .driver_info = RTL8812}, /* NEC - WL900U */
	...
	{USB_DEVICE(0x2019, 0xAB30), .driver_info = RTL8812}, /* Planex - GW-900D */
	...
	{USB_DEVICE(0x0BDA, 0x8812), .driver_info = RTL8812}, /* Elecom - WDC-867U3 */
	/*=== Patched ID ===*/
	...
	{USB_DEVICE(0x056E, 0x400F), .driver_info = RTL8821}, /* Elecom - WDB-433SU2M2 */
